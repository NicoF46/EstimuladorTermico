...
U 1 1 5DA9A50D
P 9100 3850
F 0 "#PWR013" H 9100 3600 50  0001 C CNN
...
U 1 1 5DB11DC8
P 2700 5800
F 0 "A1" H 2700 4711 50  0000 C CNN
F 1 "Arduino_Nano_v3.x" H 2700 4620 50  0000 C CNN
F 2 "Module:Arduino_Nano" H 2850 4850 50  0001 L CNN
F 3 "http://www.mouser.com/pdfdocs/Gravitech_Arduino_Nano3_0.pdf" H 2700 4800 50  0001 C CNN
	1    2700 5800
	1    0    0    -1  
$EndComp
...
U 1 1 5DB6759D
P 7950 4950
F 0 "U1" H 7950 5317 50  0000 C CNN
F 1 "LM2902" H 7950 5226 50  0000 C CNN
F 2 "" H 7900 5050 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/lm2902-n.pdf" H 8000 5150 50  0001 C CNN
	1    7950 4950
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5DB9E1BA
P 9800 1350
F 0 "C5" H 9915 1396 50  0000 L CNN
F 1 "0.33u" H 9915 1305 50  0000 L CNN
...
U 1 1 5DBD5433
P 7250 5250
F 0 "R3" H 7320 5296 50  0000 L CNN
F 1 "39k" H 7320 5205 50  0000 L CNN
...
U 1 1 5DBD9E8B
P 7600 5600
F 0 "R5" H 7670 5646 50  0000 L CNN
F 1 "27k" H 7670 5555 50  0000 L CNN
...
U 1 1 5DBDA8F2
P 7950 5350
F 0 "R4" V 7743 5350 50  0000 C CNN
F 1 "39k" V 7834 5350 50  0000 C CNN
...
U 1 1 5DBF66F3
P 7800 4250
F 0 "J2" H 7880 4242 50  0000 L CNN
F 1 "BorneraGrupoTermistores" H 7880 4151 50  0000 L CNN
...
Wire Wire Line
	1900 3650 2350 3650
Text GLabel 7250 4200 1    50   Input ~ 0
REF_OPAMPS
Wire Wire Line
	7250 4200 7250 4250
Wire Wire Line
...
U 1 1 5DB01255
P 3950 4700
F 0 "C12" H 4065 4746 50  0000 L CNN
F 1 "100n" H 4065 4655 50  0000 L CNN
...
U 1 1 5DB11B9A
P 5200 5300
F 0 "C13" H 5315 5346 50  0000 L CNN
F 1 "4.7n" H 5315 5255 50  0000 L CNN
...
U 1 1 5DB42191
P 6900 5250
F 0 "C14" H 7015 5296 50  0000 L CNN
F 1 "4.7n" H 7015 5205 50  0000 L CNN
...
U 1 1 5DE3AC3D
P 3600 5550
F 0 "#PWR0101" H 3600 5300 50  0001 C CNN
...
U 1 1 5DE3A5E4
P 3700 5300
F 0 "C9" H 3815 5346 50  0000 L CNN
F 1 "100n" H 3815 5255 50  0000 L CNN
